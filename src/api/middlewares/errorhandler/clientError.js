import {ClientError}  from './baseError';
...
export class ProxyAuthentication extends ClientError {
    code;
    constructor(message, options = {}) {
        super(message);
        this['code'] = 407;
...
export class RequestedRangeNotSatisfiable extends ClientError {
    code;
    constructor(message, options = {}) {
        super(message);
        this['code'] = 416;
...
export class SessionCreateFailure extends ClientError {
    code;
    constructor(message, options = {}) {
        super(message);
        this['code'] = 401;
...
export class SessionExpired extends ClientError {
    ...
    constructor(message, options = {}) {
        ...
        this['description'] =
            'Session used by the client is expired. User must log out and log back in.';
...
export class UnknownSession extends ClientError {
    code;
    constructor(message, options = {}) {
        super(message);
        this['code'] = 401;
